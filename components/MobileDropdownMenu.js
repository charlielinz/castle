  ...
  return (
    <div className="absolute z-30 transform -translate-x-64 mt-2 text-base">
      <ul
        className={
          isOpened
            ? "w-80 p-4 bg-white rounded-lg shadow-md transition duration-500 opacity-100"
            : "invisible w-40 p-4 bg-white rounded-lg shadow-md transition duration-500 opacity-0"
        }
      >
        <li className="p-2 text-xl rounded-sm">
