    ...
    <footer className="bg-gray-50 h-48 pb-2 text-gray-500 flex flex-col items-center justify-end">
      <div>
        <a
          ...
          rel="noreferrer"
        >
          <button className="fab fa-facebook text-4xl h-10 w-10 px-0.5 mx-0.5"></button>
        </a>
        <a
          ...
          rel="noreferrer"
        >
          <button className="fab fa-instagram text-4xl h-10 w-10 px-0.5 mx-0.5"></button>
        </a>
        <a
          ...
          rel="noreferrer"
        >
          <button className="fab fa-linkedin-in text-4xl h-10 w-10 px-0.5 mx-0.5"></button>
        </a>
        <a
          ...
          rel="noreferrer"
        >
          <button className="fab fa-github text-4xl h-10 w-10 px-0.5 mx-0.5"></button>
        </a>
      </div>
